#!/usr/bin/env python3
"""
Coordinator script for testing PyTorch Scatter wheels from GitHub Actions.
...
Example:
    GITHUB_TOKEN=... python test_coordinator.py https://github.com/astral-sh-build/build-pytorch-scatter/actions/runs/21763088084
"""
...
def get_wheel_artifacts_from_github_actions(
    ...
    # Example: https://github.com/astral-sh-build/build-pytorch-scatter/actions/runs/21763088084/job/12345
    match = re.match(
...
def main():
    ...
    print("=" * 80)
    print("PyTorch Scatter Wheel Test Coordinator")
    print("=" * 80)
    print()
